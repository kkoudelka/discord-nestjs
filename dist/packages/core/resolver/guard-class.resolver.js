...
exports.GuardClassResolver = void 0;
...
let GuardClassResolver = class GuardClassResolver {
    constructor(guardResolver, metadataProvide, metadataScanner) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var allClassMethods_1 = __asyncValues(allClassMethods), allClassMethods_1_1; allClassMethods_1_1 = yield allClassMethods_1.next(), !allClassMethods_1_1.done;) {
                    ...
                    yield this.guardResolver.addGuard({
                        instance,
                        methodName,
                    }, metadata);
                }
