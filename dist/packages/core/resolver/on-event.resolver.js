...
exports.OnEventResolver = void 0;
...
let OnEventResolver = class OnEventResolver {
    ...
    resolve(options) {
        ...
        this.discordService
            .getClient()
            .on(event, (...data) => __awaiter(this, void 0, void 0, function* () {
...
exports.OnEventResolver = OnEventResolver;
